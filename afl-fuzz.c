...
struct queue_entry {
  ...
  u64 exec_us,                        /* Execution time (us)              */
      ...
      depth,                          /* Path depth                       */
      from_stage,                     /* The seed is produced in that way  */
...
static u8 fuzz_one(char** argv) {
  ...
  /*We believe that the seed generated by havoc has a low degree of relevan
  ...
  if(queue_cur->from_stage && queue_cur->depth >1 && UR(100) < SKIP_NFAV_OLD_PROB){
      goto havoc_stage;
  }
